...
- `cd experiments; bash run_experiments.sh` runs the full experiments as presented in [1]. Expected run time: > 24 hours.
...
- If you want to run all benchmarks anyways, you can reduce the number of repetitions per experiment. To do this, open one of the respective shell scripts in the `experiments` folder, and reduce the value of variable `reps`, e.g. to `reps=2`.
