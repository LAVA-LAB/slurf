...
python generate_table.py --folder 'stats_bounds/kanban/' --outfile 'Table2_kanban.csv' --mode lower_bounds;
#
...
python generate_table.py --folder 'stats_bounds/rc/' --outfile 'Table2_rc.csv' --mode lower_bounds;