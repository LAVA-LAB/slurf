...
for (( i=0; i < $reps; ++i )); do
	for N in 100 200 400 800; do
		for props in 50 100 200 400 800; do
...
python generate_table.py --folder 'output/stats_runtime/sir/' --outfile 'output/table3_sir20.csv' --mode scen_opt_time;
#
...
python generate_table.py --folder 'output/stats_runtime/rc/' --outfile 'output/table3_rc1-1.csv' --mode scen_opt_time;