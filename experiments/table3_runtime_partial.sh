...
python generate_table.py --folder 'stats_runtime/sir/' --outfile 'experiments/results/table3_sir20_partial.csv' --mode scen_opt_time;
#
...
python generate_table.py --folder 'output/stats_runtime/rc/' --outfile 'experiments/results/table3_rc1-1_partial.csv' --mode scen_opt_time;