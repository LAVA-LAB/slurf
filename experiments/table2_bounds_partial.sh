...
python generate_table.py --folder 'output/stats_bounds/kanban/' --outfile 'experiments/results/table2_kanban_partial.csv' --mode lower_bounds;
#
...
python generate_table.py --folder 'output/stats_bounds/rc/' --outfile 'experiments/results/table2_rc_partial.csv' --mode lower_bounds;