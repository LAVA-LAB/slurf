...
python generate_table.py --folder 'output/stats_bounds/kanban/' --outfile 'experiments/results/table2_kanban.csv' --mode lower_bounds;
#
...
python generate_table.py --folder 'output/stats_bounds/rc/' --outfile 'experiments/results/table2_rc.csv' --mode lower_bounds;