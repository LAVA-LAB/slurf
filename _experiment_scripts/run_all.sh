...
# === CTMCS ===
# SIR
python3 runfile.py --model ctmc/epidemic/sir20.sm --N [100,200] --prop_file properties25.xlsx --seeds 3 --rho_min 0.1 --rho_max_iter 1;
python3 runfile.py --model ctmc/epidemic/sir60.sm --N [100,200] --prop_file properties25.xlsx --seeds 3 --rho_min 0.1 --rho_max_iter 1;
python3 runfile.py --model ctmc/epidemic/sir140.sm --N [100,200] --prop_file properties25.xlsx --seeds 3 --rho_min 0.1 --rho_max_iter 1;
#
#
# buffer
python3 runfile.py --model ctmc/buffer/buffer.sm --N [100,200] --pareto_pieces 5;
#
#
# tandem
...
python3 runfile.py --model ctmc/polling/polling.15.prism --N [100,200];
